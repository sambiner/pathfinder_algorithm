/*
 Filename: MazeState.hava
 Description: The class representing a state in the MazeProblem, i.e., a position in the maze
 Author: Sam Biner
 Date: 1/23/2023
 */
...
public class MazeState {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.col, this.row, this.KEY_PIECE);
    }
