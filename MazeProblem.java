/*
 Filename: MazeProblem.java
 Description: Specifies the Maze Grid pathfinding problem including the actions, transitions, goal test, and solution test. 
                Can be fed as an input to a Search algorithm to find and then test a solution.
 Author: Sam Biner
 Date: 1/23/2023
 */
            ...
            for (int col = 0; col < cols; col++) {
                ...
                switch (cell) {
                    ...
                    case '3':
                        ...
                        foundGoal = new MazeState(col, row, "" + cell);
                        break;
                    case '.':
                    case 'X':
                        break;
